...
func _update_transform_gizmo_view() -> void:
	...
	var camera := ViewCamera.singleton
	var xform := transform
...
func _get_ray_pos(pos : Vector2) -> Vector3:
	return ViewCamera.singleton.project_ray_origin(pos - ViewConrol.world_position)

func _get_ray(pos : Vector2) -> Vector3:
	return ViewCamera.singleton.project_ray_normal(pos - ViewConrol.world_position)

func _get_camera_normal() -> Vector3:
	return -ViewCamera.singleton.global_transform.basis[2]

func _point_to_screen(point : Vector3) -> Vector2:
	return ViewCamera.singleton.unproject_position(point) + ViewConrol.world_position
